CREATE TYPE "public"."group_type" AS ENUM('event', 'announcement', 'poster');--> statement-breakpoint
CREATE TYPE "public"."user_role" AS ENUM('dean', 'student_council', 'student_club');--> statement-breakpoint
